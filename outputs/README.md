...
time-window pull-forward, and `49207.47` for address-change proxy. PNG plots in
the scenario subfolders were generated by the earlier full output pass and are
retained for paper visualization.
